            ...
            <div>
                ...
                <Container>
                    <BannerWrapper>
                        <BannerDiv>
                            <BannerText
                                style={{ marginLeft: '249px', zIndex: '2' }}
                            >
                                make our{stairs} cORE time table Let's start
                                {summertime_sadness} the project make our cORE
                                time table{lightning} Let's start the project
                            </BannerText>
                        </BannerDiv>
                    </BannerWrapper>
                </Container>
                ...
                <Container style={{ marginTop: '391px' }}>
                    <BannerWrapper>
                        <BannerDiv>
                            <BannerText
                                style={{ marginLeft: '1307px', zIndex: '1' }}
                            >
                                make our{stairs} cORE time table Let's start
                                {summertime_sadness} the project make our cORE
                                time table{lightning} Let's start the project
